...
A personal internship & job opportunity tracker — a faster, nicer replacement
for the application-tracking spreadsheet.
...
better-sqlite3. No accounts, no cloud — everything stays on this machine.
